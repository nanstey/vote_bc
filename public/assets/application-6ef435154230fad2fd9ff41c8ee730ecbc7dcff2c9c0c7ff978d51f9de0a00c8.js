...
$(document).on("turbolinks:load", function() {
  ...
  $(".translucent").delay(800).animate({ opacity: 1 }, 1300);
...
//Loads in transparent mode if most recent election is selected
  if ((window.location.pathname === '/election/' + 2020 || window.location.pathname === '/') && $(window).scrollTop() < 20) {
    $('.navbar').addClass('at-top');
  }

// Adds or removes transparency on scroll
  $(window).scroll(function () {
    if (window.location.pathname === '/election/' + 2020 || window.location.pathname === '/') {
